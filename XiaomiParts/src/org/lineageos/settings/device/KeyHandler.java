...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private static final int SCANCODE_JASMINE_UP = 195;
    private static final int SCANCODE_JASMINE_DOWN = 196;
    private static final int SCANCODE_JASMINE_LEFT = 197;
    private static final int SCANCODE_JASMINE_RIGHT = 198;
